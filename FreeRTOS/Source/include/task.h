...
//#ifndef XGMISSEDDEADLINE_XY_
//#define XGMISSEDDEADLINE_XY_
//portBASE_TYPE xgMissedDeadline_xy_=-1;
//#endif
 ...
 * \ingroup Tasks
 */
#define xTaskCreate( pvTaskCode, pcName, usStackDepth, pvParameters, uxPriority, pxCreatedTask, ulWCET, ulPeriod, ulRelativeDeadline ) xTaskGenericCreate( ( pvTaskCode ), ( pcName ), ( usStackDepth ), ( pvParameters ), ( uxPriority ), ( pxCreatedTask ), ( NULL ), ( NULL ), (ulWCET), (ulPeriod), (ulRelativeDeadline) )
